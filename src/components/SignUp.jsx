                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="form-group">
                                        <input type="name" className="form-control" placeholder="Nombre" name="nombre" onChange={(e) => setUsuario(e.target.value)}required></input>
                                    </div>
                                </div>
                                <div className="col-md-12">
                                    <div className="form-group">
                                ...
                                <div className="col-md-12">
                                    <div className="form-group">
                                        <input type="text" className="form-control" placeholder="Teléfono" name="telefono" onChange={(e) => setTelefono(e.target.value)} required></input>
                                    </div>
                                </div>
                                <div className="col-md-12">
                                    <div className="form-group">
                                ...
                                <div className="col-md-12">
                                    <div className="form-group">
                                        <input type="text" className="form-control" placeholder="Número de Documento" name="documento" onChange={(e) => setDocumento(e.target.value)}required></input>
                                    </div>
                                </div>
                                <div className="col-md-12">
                                    <div className="form-group">
                                        <div className="form-field">
                                            <div className="select-wrap">
                                                ...
                                                <select id="tipoDocumento" className="form-control" name="tipodedocumento" required>
                                                    <option value="CC" className="option-color">Tipo de Documento</option>
